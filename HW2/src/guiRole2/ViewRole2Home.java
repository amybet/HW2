...
public class ViewRole2Home {
	...
	**********************************************************************************************/
	...
	/**
	 * Label displaying the user's details on the Role 2 Home Page.
	 */
	...
	private static ViewRole2Home theView;		// Used to determine if instantiation of the class is needed
	...
	**********************************************************************************************/
	...
	private ViewRole2Home() {
		...
		theRole2HomeScene.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
