 ...
 * @version 1.02		2026-02-07 updated to force log out on first account setup
 *  
 */

public class ViewUserUpdateFIRST {
	...
	private static Button button_ProceedToUserHomePage = new Button("Log Out");
	...
	private static ViewUserUpdateFIRST theView;	// Used to determine if instantiation of the class
											// is needed
	...
	/**
	 * The Scene each invocation populates for the initial User Update view.
	 */
	...
	public static void displayUserUpdate(Stage ps, User user) {
		...
		if (theView == null) theView = new ViewUserUpdateFIRST();
...
;        
        ...
        button_ProceedToUserHomePage.setOnAction((_) -> 
        	{ControllerUserUpdate.goToLogIn(theStage);});
