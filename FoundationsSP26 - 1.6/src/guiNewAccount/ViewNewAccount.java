...
public class ViewNewAccount {
	...
	*/
    ...
    /**
	 * Access to the New Account page's GUI Widgets.
	 */
	...
	*/
	...
	private ViewNewAccount() {
		...
		DialogPane alertUsernamePasswordErrorPane = alertUsernamePasswordError.getDialogPane();
		alertUsernamePasswordErrorPane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		alertUsernamePasswordErrorPane.getStyleClass().add("alertStyle-error");

		DialogPane alertInvitationCodeIsInvalidPane = alertInvitationCodeIsInvalid.getDialogPane();
		alertInvitationCodeIsInvalidPane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		alertInvitationCodeIsInvalidPane.getStyleClass().add("alertStyle-error");
		
		DialogPane alertInvalidPasswordErrorPane = alertInvalidPasswordError.getDialogPane();
		alertInvalidPasswordErrorPane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());

		DialogPane alertInvalidUsernameErrorPane = alertInvalidUsernameError.getDialogPane();
		alertInvalidUsernameErrorPane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		alertInvalidUsernameErrorPane.getStyleClass().add("alertStyle-error");
