...
public class ViewMultipleRoleDispatch {
	...
	**********************************************************************************************/
	...
	/**
	 * Sets up and displays the Multiple Role Dispatch page. 
	 * Determines the current user's available roles and populates the ComboBox selection.
	...
	/**
	 * Initializes all the elements of the graphical user interface.
	...
	private ViewMultipleRoleDispatch() {
		...
		theMultipleRoleDispatchScene.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
