...
public class ViewAddRemoveRoles {
	...
	**********************************************************************************************/
	...
	// Used to determine if instantiation of the class is needed
	...
	/**
	 * The Scene that this invocation populates for the Add/Remove Roles page.
	 */
	...
	**********************************************************************************************/
	 ...
	 * * <p>It first sets up every shared attributes so we don't have to pass parameters.</p>
	 * * <p>It then checks to see if the page has been setup. If not, it instantiates the
	 * class, initializes all the static aspects of the GUI widgets (e.g., location on the
	 * page, font, size, and any methods to be performed).</p>
	 * * <p>After the instantiation, the code then populates the elements that change
	 * based on the user and the system's current state. It then sets the Scene onto the stage, 
	 * and makes it visible to the user.</p>
	...
	public static void displayAddRemoveRoles(Stage ps, User user) {
		...
		// current state of the system. This page is different from the others. Since there are
		// two modes (1: user has not been selected, and 2: user has been selected) there
		// are two lists of widgets to be displayed. For this reason, we have implemented the
		// following two controller methods to deal with this dynamic aspect.
	 ...
	 * handlers for each GUI object.
	 * * <p>This is a singleton, so this is performed just once. Subsequent uses fill in
	 * the changeable fields using the displayAddRemoveRoles method.</p>
	 */
	public ViewAddRemoveRoles() {
		...
		// Due to the very dynamic nature of this page, setting the widgets into the
		// Root Pane has
	...
	**********************************************************************************************/
	...
	/**
	 * Clears the "Select Role to Add" combobox, populates it with available user roles, 
	 * and then shows the combobox to the user.
	 */
