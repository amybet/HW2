 ...
 * requires and there may be defects in this code.</p>
 * * <p>The class has been written using a singleton design pattern and is the View portion of the 
 * Model, View, Controller pattern. The pattern is designed that all accesses to this page and
 * its functions start by invoking the static method displayAdminHome. No other method should 
 * attempt to instantiate this class as that is controlled by displayAdminHome. It ensures that
 * only one instance of the class is instantiated and that one is properly configured for each use.</p>
 * * <p>Please note that this implementation is not appropriate for concurrent systems with multiple
...
public class ViewAdminHome {
	...
	**********************************************************************************************/
	...
	/**
	 * Label displaying the current user's details at the top of the Admin home page.
	 */
	...
	/**
	 * Label displaying the total number of outstanding user invitations.
	 */
	public static Label label_NumberOfInvitations = new Label("Number of Oustanding Invitations: x");
	
	/**
	 * Label displaying the total number of users currently in the database.
	 */
	...
	/**
	 * A text input dialog allowing an admin to input a new One-Time Password for a selected user.
	 */
	public static TextInputDialog Dialog_OneTimePass = new TextInputDialog("");
	
	/**
	 * A choice dialog allowing an admin to select which user will receive a new One-Time Password.
	 */
	...
	/**
	 * The Stage that JavaFX has established for the Admin Home scene.
	 */
	...
	**********************************************************************************************/
	...
	/**
	 * This method is the single entry point from outside this package to cause
	 * the Admin Home page to be displayed.
	 * * <p>It first sets up every shared attributes so we don't have to pass parameters.
	 * It then checks to see if the page has been setup. If not, it instantiates the class, 
	 * initializes all the static aspects of the GUI widgets (e.g., location on the page, font,
	 * size, and any methods to be performed).</p>
	 * * <p>After the instantiation, the code then populates the elements that change based on the user
	...
	**********************************************************************************************/
	...
	/**
	 * Clears the contents and then re-populates the userListPane in ViewAdminHome. 
	 * When finished it shows the userListStage.
	 */	
	...
	/**
	 * Helper method to display alerts during delete operations.
	 * Centralizes alert display for consistency.
	 */
	...
	/**
	 * Helper method to display alerts during ManageInvite operations.
	 */
	...
	/**
	 * Clears the ChoiceDialog contents of ChoiceDialog_UserOTP and adds
	 * them back to account for any changes in database.
	 * @return Optional String with the selected formatted dialog box output.
	 */
	...
	/**
	 * Clears the ChoiceDialog contents of deleteChoiceDialog and adds
	 * them back to account for any changes in database.
	 * @return Optional String with the selected formatted dialog box output.
	 */
	...
	/**
	 * Creates the strings that are displayed in the drop down menu for ManageInvites.
	 * @return Optional String with the selected formatted dialog box output.
	 */
	...
	/**
	 * Helper method to update the "Outstanding Invites" count at the top of the main page.
	 */
