 ...
 * to change the Username and not all of the functions on this page are implemented.</p>
 * * <p>Currently the following attributes can be updated:</p>
 * <ul>
 * <li>First Name</li>
 * <li>Middle Name</li>
 * <li>Last Name</li>
 ...
 * <li>Email Address</li>
 * </ul>
 * <p>The page uses dialog boxes for updating these items.</p>
...
public class ViewUserUpdate {
	...
	**********************************************************************************************/
	...
	private static ViewUserUpdate theView;	// Used to determine if instantiation of the class is needed
	...
	/**
	 * The Scene each invocation populates for the User Update view.
	 */
	...
	**********************************************************************************************/
	 ...
	 * * <p>It first sets up shared attributes so we don't have to pass parameters.
	...
	/**
	 * This method attaches a validator to a button's "ok" press, and sets up a visible error code label.
	 * * @param dialog    The Dialog Box
	 * @param validator The function that will call the validator
	 */
	private void attachInlineValidator(TextInputDialog dialog, Function<String, String> validator) {
